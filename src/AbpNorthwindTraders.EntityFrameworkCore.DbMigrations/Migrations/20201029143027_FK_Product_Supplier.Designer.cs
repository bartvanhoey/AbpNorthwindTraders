...
namespace AbpNorthwindTraders.Migrations
{
    ...
    [Migration("20201029143027_FK_Product_Supplier")]
    partial class FK_Product_Supplier
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Customer", b =>
                {
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.EmployeeTerritory", b =>
                {
                    ...
                    b.ToTable("AppEmployeeTerritories");
                });

            modelBuilder.Entity("AbpNorthwindTraders.Domain.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductID")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Shipper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppShippers");
                });

            modelBuilder.Entity("AbpNorthwindTraders.Domain.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SupplierID")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Territory", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnName("TerritoryID")
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Employee", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Employee", "Manager")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.EmployeeTerritory", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Employee", "Employee")
                        .WithMany("EmployeeTerritories")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_EmployeeTerritories_Employees")
                        .IsRequired();

                    b.HasOne("AbpNorthwindTraders.Domain.Territory", "Territory")
                        .WithMany("EmployeeTerritories")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Order", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Customer", "Customer")
                        .WithMany("Orders")
                    ...
                    b.HasOne("AbpNorthwindTraders.Domain.Shipper", "Shipper")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.OrderDetail", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK_Order_Details_Orders")
                        .IsRequired();

                    b.HasOne("AbpNorthwindTraders.Domain.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Product", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId");

                    b.HasOne("AbpNorthwindTraders.Domain.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("AbpNorthwindTraders.Domain.Territory", b =>
                {
                    b.HasOne("AbpNorthwindTraders.Domain.Region", "Region")
