...
namespace AbpNorthwindTraders.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpNorthwindTradersDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpNorthwindTradersEfCoreEntityExtensionMappings to extend the IdentityUser entity
